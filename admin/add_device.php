                                ...
                                <form name="form1" action="" method="post" class="col-lg-6" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="location" class="form-control" 
                                               placeholder="Nhập vị trí (Mặc định kho tổng)">
                                    </div>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST["submit1"])) {
    ...
    if (isset($_FILES["device_image"]) && $_FILES["device_image"]["error"] === UPLOAD_ERR_OK) {
        ...
        $stmt = $link->prepare("
            INSERT INTO add_device (device_name, device_image, device_status, device_qty, available_qty, location, admin_username)
            VALUES (?, ?, ?, ?, ?, ?, ?)
        ");
        if ($stmt) {
